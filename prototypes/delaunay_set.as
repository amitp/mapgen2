...
package {
  ...
  public class delaunay_set extends Sprite {
    ...
    public function go():void {
      ...
      // TODO: build voronoi data structure
      
      function drawNoisyLine(p:XYZ, q:XYZ, style:Object=null):void {
      ...
      function inside(xyz:XYZ):Boolean {
      ...
      for (i = 0; i < 600; i++) {
        ...
        graphics.drawCircle(xyz.x, xyz.y, 3);
        graphics.endFill();
      }
      ...
      for each (var tri:ITriangle in triangles) {
          function D(p1:int, p2:int, p3:int):void {
            ...
            if (p1 < p2) {
              ...
              else if (!i1 && !i2) color = 0x8888bb;
              drawNoisyLine(pxyz[p1], pxyz[p2], {color: color});
            }
          }
